...
const CardDisplay = memo(({ originalName, card, onUpdate, isForPrinting = false }: { originalName: string, card: ItemCardData, onUpdate: (itemName: string, field: keyof ItemCardData, value: string) => void, isForPrinting?: boolean }) => {
    ...
    const adjustFontSize = useCallback(() => {
        ...
        let size = 18; // Max font size starting point
        text.style.fontSize = `${size}px`;
        text.style.lineHeight = "1.2";

        // Iteratively shrink font until it fits height-wise with a safety margin
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col h-full">
                {/* NAME SECTION - Fixed height 50px */}
                ...
                {/* INFO SECTION - Fixed height 20px */}
                ...
                {/* DESCRIPTION SECTION - Dynamic fitting */}
                ...
                {/* ATTUNEMENT SECTION - Anchored to bottom */}
    ...
    return (
        ...
        >
            ...
            <div className="relative z-10 flex flex-col h-full">
                ...
                {/* DETAILS - Aligned carefully between dividers */}
