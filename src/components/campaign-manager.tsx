...
import { WorldArchitect } from './world-architect';
import { NpcGenerator } from './npc-generator';
import { CombatGenerator } from './combat-generator';
...
export function CampaignManager({
  ...
  // Determiniamo se siamo in modalità creazione basandoci sulla mancanza di una campagna attiva 
  // o sul parametro esplicito nell'URL.
  ...
  // Effetto per caricare la prima campagna se l'URL è vuoto e non siamo in modalità creazione
  useEffect(() => {
  ...
  const handleStartNewCampaign = () => {
    // Usiamo window.location per forzare un ricaricamento pulito ed evitare blocchi della UI (Radix Dialog Lock)
    ...
    reader.onload = async (e) => {
      try {
        ...
        if (result.success) {
            ...
            // Dopo il ripristino, forziamo un ricaricamento pulito della root per caricare le campagne ripristinate
