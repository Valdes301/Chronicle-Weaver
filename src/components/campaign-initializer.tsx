...
import { Wand2, Upload, ChevronLeft } from 'lucide-react';
...
export function CampaignInitializer({ onCreateCampaign, onCancel }: CampaignInitializerProps) {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen text-center p-4 overflow-hidden">
      ...
      <h1 className="font-headline text-5xl md:text-7xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 leading-tight">
