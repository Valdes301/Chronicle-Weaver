...
import { ShieldCheck, Swords, PlusCircle, Plus, Trash2, Pencil, ChevronDown, CheckCircle, Filter, ArrowUp, X, Sword, Shield, Heart, Beaker, Zap } from 'lucide-react';
    ...
    <Tabs defaultValue="armor" className="w-full">
      <div className="flex justify-between items-start mb-2">
        ...
        <MagicItemFormDialog
            ...
            onSave={onSaveItem}
            item={{ type: 'Armatura (personalizzata)', techType: 'defense' }}
