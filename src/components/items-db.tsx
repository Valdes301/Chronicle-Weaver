...
import { Sparkles, PlusCircle, Plus, Pencil, Trash2, ChevronDown, CheckCircle, Filter, ArrowUp, Coins, ImagePlus, Upload, Sword, Gem, Heart, Beaker, Shield, Zap, Loader2, X } from 'lucide-react';
...
const magicItemSchema = z.object({
  ...
  techType: z.enum(['damage', 'defense', 'cure', 'alchemy', 'charges', 'none']).optional(),
      ...
      <CardHeader>
        <div className="flex justify-between items-start">
            <div>
                ...
                <CardDescription>Consulta oggetti meravigliosi, pozioni e altri oggetti magici. Carica immagini per rendere unico il tuo tesoro.</CardDescription>
            </div>
             <MagicItemFormDialog
