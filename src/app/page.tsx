...
async function getCampaignsData(activeCampaignId?: string): Promise<{ 
    ...
    try {
        ...
        return { campaigns, activeCampaign: activeCampaignData, activeArc: activeArc || null, sessions, magicItems, monsters, playerCharacters, customSpells, customSkills, possessedItems: possessedItems.map(i => i.itemName), letterPresets, shops, worldLocations, npcs, combats };
