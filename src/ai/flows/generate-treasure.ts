...
const prompt = ai.definePrompt({
  ...
  prompt: `Sei un Maestro dei Tesori per D&D 5e. Devi generare un bottino memorabile e coerente.
...
2. **Monete e Gioielli**: Se permessi, devono essere descritti in modo evocativo (es. "Una borsa di seta contenente 50 mo con l'effigie del Re").
