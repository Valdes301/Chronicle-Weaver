 ...
 * Progettato per essere token-efficient e rispettare rigorosamente la timeline.
 */
...
const prompt = ai.definePrompt({
  ...
  prompt: `Sei il Grande Cronista delle ere perdute. Il tuo compito è mantenere e aggiornare la cronaca epica di una campagna di D&D.
