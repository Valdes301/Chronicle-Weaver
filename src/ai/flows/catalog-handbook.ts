 ...
 * Supporta testo e immagini per estrarre dati tecnici da manuali D&D 5e.
 */
...
const prompt = ai.definePrompt({
    ...
    prompt: `Sei il Grande Bibliotecario di Candlekeep. Il tuo compito è catalogare i dati di D&D 5e con precisione chirurgica.
